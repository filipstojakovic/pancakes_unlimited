package net.croz.pancakes_unlimited.advices;

import net.croz.pancakes_unlimited.exceptions.HttpException;
import net.croz.pancakes_unlimited.utils.LoggingUtil;
